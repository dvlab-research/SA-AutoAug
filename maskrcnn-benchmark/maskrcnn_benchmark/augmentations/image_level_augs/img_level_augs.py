import random
import numpy as np
from maskrcnn_benchmark.augmentations.image_level_augs.zoom_in import Zoom_in
from maskrcnn_benchmark.augmentations.image_level_augs.zoom_out import Zoom_out
...
class Img_augs(object):
    ...
    def __call__(self, tensor, target):
        ...
        tensor_out, target_out = scale_jitter(tensor_out, target_out, jitter_factor)
